...
/// Holds the information of a line used in a [MyRacingLinesBehaviour].
class Line {
...
class MyRacingLinesBehaviour extends Behaviour {
  static final math.Random random = math.Random();

  /// Creates a new racing lines behaviour
  MyRacingLinesBehaviour({this.direction = LineDirection.Ltr, int numLines = 50})
  ...
  void initLine(Line line) {
    ...
    line.thickness = random.nextInt(1) + 1;
    // line.color = HSVColor
    //     .fromAHSV(
    ...
    //     )
    //     .toColor();
    line.color = Colors.yellowAccent[400].withOpacity(0.2);
  }
  ...
  void initFrom(Behaviour oldBehaviour) {
    if (oldBehaviour is MyRacingLinesBehaviour) {
